...
import static com.github.ptitnoony.apps.bowling.hmi.FxDrawing.CELL_NAME_RATIO;
import static com.github.ptitnoony.apps.bowling.hmi.FxDrawing.DEFAULT_CELL_HEIGHT;
import static com.github.ptitnoony.apps.bowling.hmi.FxDrawing.DEFAULT_CELL_WIDTH;
 ...
 */
public class ConfrontationDrawing extends Pane {
    ...
    public ConfrontationDrawing(Confrontation c) {
        super();
        confrontation = c;
    ...
    private void init() {
        ...
        //Players' games
        for (Round g : confrontation.getRounds()) {
            PlayerGameDrawing playerGameDrawing = new PlayerGameDrawing(g);
